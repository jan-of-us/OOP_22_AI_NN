...
class RF_Regression(Regression):
    ...
    def __init__(self, data_obj: Regression_Data):
        ...
        self.predictions, self.train_predictions, self.feature_importance_for_chart = None, None, None
...
def main():
    ...
    data_obj = Regression_Data(data=data, x_labels=["date"], y_label="Appliances", n_values=50,
                               test_size=0.2, trees=50, scale=True)
